...
export default function Home() {
  ...
  const eventCategories = [
    {
      name: "Conferences",
      description: "Large-scale events with industry leaders and keynote speakers",
      icon: Mic,
      color: "bg-purple-500",
      count: allEvents.filter(e => e.category === 'conference' && new Date(e.startDate) > new Date()).length,
    },
    {
      name: "Meetups",
      ...
      icon: Users,
      color: "bg-blue-500",
      count: allEvents.filter(e => e.category === 'meetup' && new Date(e.startDate) > new Date()).length,
    },
    {
      name: "Hackathons",
      ...
      icon: Code2,
      color: "bg-green-500",
      count: allEvents.filter(e => e.category === 'hackathon' && new Date(e.startDate) > new Date()).length,
    },
    {
      name: "Workshops",
      ...
      icon: Zap,
      color: "bg-orange-500",
      count: allEvents.filter(e => e.category === 'workshop' && new Date(e.startDate) > new Date()).length,
    },
    {
      name: "X-Spaces",
      ...
      icon: Globe,
      color: "bg-indigo-500",
      count: allEvents.filter(e => e.category === 'x-space' && new Date(e.startDate) > new Date()).length,
    },
  ];
  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto">
                Join the LBD community and discover amazing events that inspire innovation, 
                foster learning, and connect builders from around the world.
              </p>
                        ...
                        <div className="p-6">
                          ...
                          <div className="space-y-2 mb-4">
                            ...
                            <div className="flex items-center gap-2 text-gray-600">
                              ...
                              <span className="text-sm truncate">{event.location.details}</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-600">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Discover different types of events tailored to your interests and expertise
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {eventCategories.map((category, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className={`inline-flex items-center justify-center w-12 h-12 ${category.color} rounded-xl text-white`}>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 hover:bg-white hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group border border-gray-100 border-dashed">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">We're always adding new event types based on community needs</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="community" className="py-20 bg-[#8E0EB9] relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-purple-100 mb-10 max-w-2xl mx-auto">
              Join thousands of builders, creators, and innovators in the LBD community. 
              Discover events, share knowledge, and collaborate on the future of technology.
            </p>
